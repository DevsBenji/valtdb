...
from valtdb.crypto import decrypt_data, encrypt_data, generate_keypair, hash_data, verify_hash
...
class TestCrypto(unittest.TestCase):
    ...
    def test_large_data_encryption(self):
        ...
        large_data = {"large_string": "x" * 1000000, "large_list": list(range(10000))}  # 1MB string
