...
class Table:
    ...
    def aggregate(self, query: Optional[Query] = None, group_by: Optional[List[str]] = None,
                 aggregations: Dict[str, List[str]] = None) -> List[Dict[str, Any]]:
    ...
    def _aggregate_all(self, rows: List[Dict[str, Any]], 
                      aggregations: Dict[str, List[str]]) -> List[Dict[str, Any]]:
